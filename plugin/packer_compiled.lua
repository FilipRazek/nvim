...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/filip/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  neovim = {
    ...
    loaded = true,
    path = "/home/filip/.local/share/nvim/site/pack/packer/start/neovim",
  ...
  undotree = {
    loaded = true,
    path = "/home/filip/.local/share/nvim/site/pack/packer/start/undotree",
    url = "https://github.com/mbbill/undotree"
  },
  ["vim-fugitive"] = {
    loaded = true,
    path = "/home/filip/.local/share/nvim/site/pack/packer/start/vim-fugitive",
